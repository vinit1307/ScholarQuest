...
<%
    ...
    if(sot.equals("a-z"))
    {
    	 cat =" SELECT id, name, provider, last_date, category FROM ScholarshipData ORDER BY name ASC";
    }
    else if(sot.equals("z-a"))
    {
   cat =" SELECT id, name, provider, last_date, category FROM ScholarshipData ORDER BY name DESC";
    }
    else if(sot.equals("Alwaysopen"))
    {
    	 b=1;
    	 cat =" SELECT id, name, provider, last_date, category FROM ScholarshipData WHERE last_date=?";
    }
    else {
    }
...
<head>
    ...
    <style>
        ...
        .scholarship-box:hover { transform: scale(1.1); }
    ...
    <div class="row">
        ...
        %>
            <div class="col-md-4 d-flex">
                <div class="scholarship-box" onclick="redirectToDetails('<%= rs.getInt("id") %>')">
                    <h3><%= name %></h3>
